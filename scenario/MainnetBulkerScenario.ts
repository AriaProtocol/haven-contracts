...
scenario(
  ...
  async ({ comet, actors, bulker }, context) => {
    ...
    const wstETH = await context.world.deploymentManager.hre.ethers.getContractAt('contracts/utils/interfaces/IWstETH.sol:IWstETH', MAINNET_WSTETH_ADDRESS) as IWstETH;
