...
export default async function deploy(
  ...
  const IPRWA2PriceFeed = await makePriceFeed(
    deploymentManager,
    'IPRWA2:priceFeed',
    34.5,
    8
  ...
  return { IP, IPRWA1, IPRWA2, USDC, WBTC, WETH, USDCPriceFeed, WBTCPriceFeed, WETHPriceFeed, IPFeed, IPRWA1PriceFeed, IPRWA2PriceFeed };
}
